...
const ABOUT_US_URL =
  "https://alm-biz-web-strapi-dev.almosafer.com/api/about-us?locale={locale}&populate[]=localizations,meta,hero.image,featuredCard.cards,featuredCard.cards.image,sections,sections.logos.image,sections.cards,sections.cards.image,awards,footerLinks.links,socialMedia.logo,staticLinks,corpLogo,links.logo,links.childLinks.logo,brandLogo,copyrightText,awardShield,ogImage";
